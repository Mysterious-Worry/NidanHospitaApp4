...
public class previous_patient_adapter extends RecyclerView.Adapter<previous_patient_adapter.myViewHolder> {
    ...
    public previous_patient_adapter() {
    }

    public previous_patient_adapter(ArrayList<patient_model> dataHolder, Context context, String date) {
    ...
    @NonNull
    @Override
    public previous_patient_adapter.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.patient_detail_layout, parent, false);
        return new previous_patient_adapter.myViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull previous_patient_adapter.myViewHolder holder, int position) {
        String type = "";
        int pos = position;
        ...
        holder.check_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    myDb.updateDayRecord(dtype, amount, date);
                } catch (Exception ex){
